...
export const SelectTipo = styled.View`
    ...
    font-weight: bold;
    width: ${Dimensions.get('window').width > 650 ? 650 : Dimensions.get('window').width}px;
`;
...
export const BannerView = styled.ScrollView`
    ...
    flex-direction: row;
    position: relative;
    width: ${Dimensions.get('window').width > 650 ? 640 : Dimensions.get('window').width - 10}px;
`;

export const ViewRestaurantes = styled.View`
    justify-content: center;
    margin: 10px 20px 30px 20px;
    width: ${Dimensions.get('window').width > 650 ? 600 : Dimensions.get('window').width - 50}px;
`;
